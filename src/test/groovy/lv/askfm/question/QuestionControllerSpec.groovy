...
class QuestionControllerSpec extends Specification {
    ...
    @Transactional
    def "Should ask question with bad word and receive appropriate response"() {
        when:
        def responseEntity = restTemplate.postForEntity("/ask", new Question(text: "Ask very badword1"), Question.class)
